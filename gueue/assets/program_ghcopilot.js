// ver 0.3.5 - COUNT_EXPRを5個ごと改行＆1: '1', ...形式で組み込み済み
...
// ---COUNT_EXPR 1～100---
const COUNT_EXPR = {
  1: '1', 2: '(1+1)', 3: '(0.75*(5-1))', 4: '(5-1)', 5: '5',
  6: '(1+5)', 7: '7', 8: '(1+7)', 9: '(0.75*(5+7))', 10: '(5+5)',
  11: '(1+(5+5))', 12: '(5+7)', 13: '(1+(5+7))', 14: '(19-5)', 15: '(0.75*(1+19))',
  16: '(47-31)', 17: '((19-1)-1)', 18: '(19-1)', 19: '19', 20: '(1+19)',
  21: '(0.75*(33-5))', 22: '(47-(5*5-5-7))', 23: '((5+19)-1)', 24: '(5+19)', 25: '(5*5)',
  26: '(31-5)', 27: '(0.75*(5+31))', 28: '(33-5)', 29: '((31-1)-1)', 30: '(31-1)',
  31: '31', 32: '(1+31)', 33: '33', 34: '(1+33)', 35: '(5*7)',
  36: '(5+31)', 37: '(1+(5+31))', 38: '(5+33)', 39: '(0.75*(5+47))', 40: '(7+33)',
  41: '((47-5)-1)', 42: '(47-5)', 43: '((33/0.75)-1)', 44: '(33/0.75)', 45: '(1+(33/0.75))',
  46: '(47-1)', 47: '47', 48: '(1+47)', 49: '(7*7)', 50: '(5*(1+9))',
  51: '((5+47)-1)', 52: '(5+47)', 53: '(1+(5+47))', 54: '(7+47)', 55: '(1+(7+47))',
  56: '((47-5)/0.75)', 57: '(5+(5+47))', 58: '(33+(5*5))', 59: '(5+(7+47))', 60: '(0.75*(33+47))',
  61: '((31+31)-1)', 62: '(31+31)', 63: '(1+(31+31))', 64: '(31+33)', 65: '((19+47)-1)',
  66: '(19+47)', 67: '(1+(19+47))', 68: '(19+(7*7))', 69: '(5+(31+33))', 70: '(5*(19-5))',
  71: '(5+(19+47))', 72: '((7+47)/0.75)', 73: '((31+47)-5)', 74: '((33/0.75)-(1+31))', 75: '((33+47)-5)',
  76: '(19*(5-1))', 77: '((31+47)-1)', 78: '(31+47)', 79: '(1+(31+47))', 80: '(33+47)',
  81: '(1+(33+47))', 82: '(33+(7*7))', 83: '(5+(31+47))', 84: '(7*(5+7))', 85: '(5+(33+47))',
  86: '((7*19)-47)', 87: '(7+(33+47))', 88: '((19+47)/0.75)', 89: '((47+47)-5)', 90: '(0.75*((5*5)*5+7))',
  91: '(47+(33/0.75))', 92: '((33/0.75)+(1+47))', 93: '((47+47)-1)', 94: '(47+47)', 95: '(19*5)',
  96: '(1+(47+47))', 97: '(19+(31+47))', 98: '(7*(19-5))', 99: '(5+(47+47))', 100: '(5*(1+19))'
};
...
function bfsDecompose(target, prims) {
  if (target === 0) return '0'; // 0はCOUNT_EXPRを参照しない
